...
public class Exercises_Tests {
    ...
    @Test
    @DisplayName("Given Two Numbers That Are Equal, MyMethod Returns false")
    public void givenTwoNumbersThatAreEqual_MyMethodReturnsfalse() {
        int int1 = 4;
        int int2 = 4;
        boolean result = Exercises.myMethod(int1, int2);
        Assertions.assertFalse(result);
    }

    @Test
    @DisplayName("Given Two Numbers That Give A Remainder 0, MyMethod Returns true")
    public void givenTwoNumbersThatGiveRemainder_0_MyMethodReturnstrue() {
        int int1 = 16;
        int int2 = 4;
        boolean result = Exercises.myMethod(int1, int2);
